...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "6800fe282fbbd400160e68c46de1350c"
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            ...
            if latitude_gps and longitude_gps and take_time:
                ...
                return f'{location[0]}{longitude_direction},{location[1]}{latitude_direction}'
            else:
...
if __name__ == '__main__':
    # 创建对象，请确保查询的图片为【手机相机拍摄的原图】
    location = Location('D:\\001desktop\\微信图片_20190828204627.jpg')
